...
use Zesle\Psr\Http\Message\MessageInterface;
...
abstract class Message implements MessageInterface
{
    ...
    public function withProtocolVersion(string version) -> <static>
    {
        ...
        let valid =  ["1.0" : true, "1.1" : true, "2.0" : true];
        ...
        let clone->protocolVersion = version;
        return clone;
    }
    ...
    public function getHeader(string name) -> array
    {
        ...
        return this->headers->get(name, tmpArray40cd750bba9870f18aada2478b24840a);
    }
    ...
    public function getHeaderLine(string name) -> string
    {
        ...
        let tmpArray40cd750bba9870f18aada2478b24840a = [];
        return implode(",", this->headers->get(name, tmpArray40cd750bba9870f18aada2478b24840a));
    }
