...
class Environment extends Collection implements EnvironmentInterface
{
    ...
    {
        var data, tmpArray6a71f5a0d65b6ee673b7d035c6691655;
    
        let tmpArray6a71f5a0d65b6ee673b7d035c6691655 = ["SERVER_PROTOCOL" : "HTTP/1.1", "REQUEST_METHOD" : "GET", "SCRIPT_NAME" : "", "REQUEST_URI" : "", "QUERY_STRING" : "", "SERVER_NAME" : "localhost", "SERVER_PORT" : 80, "HTTP_HOST" : "localhost", "HTTP_ACCEPT" : "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8", "HTTP_ACCEPT_LANGUAGE" : "en-US,en;q=0.8", "HTTP_ACCEPT_CHARSET" : "ISO-8859-1,utf-8;q=0.7,*;q=0.3", "HTTP_USER_AGENT" : "Slim Framework", "REMOTE_ADDR" : "127.0.0.1", "REQUEST_TIME" : time(), "REQUEST_TIME_FLOAT" : microtime(true)];
        let data =  array_merge(tmpArray6a71f5a0d65b6ee673b7d035c6691655, userData);
