...
use Zesle\Interop\Container\Exception\ContainerException;
use Zesle\Pimple\Container as PimpleContainer;
...
class Container extends PimpleContainer implements ContainerInterface
{
     ...
     * @var array
     */
    protected defaultSettings = ["httpVersion" : "1.1", "responseChunkSize" : 4096, "outputBuffering" : "append", "determineRouteBeforeAppMiddleware" : false, "displayErrorDetails" : false];
    /**
    ...
    public function __construct(array values = []) -> void
    {
        ...
        let userSettings =  isset values["settings"] ? values["settings"]  : [];
     ...
     * @return void
     */
    protected function registerDefaultServices(array userSettings)
    {
        var defaultSettings, defaultProvider;
         ...
         */
        let this["settings"] = new ContainerregisterDefaultServicesClosureOne(userSettings, defaultSettings);
        let defaultProvider =  new DefaultServicesProvider();
