...
class Mustache implements \ArrayAccess {
	...
	public function __construct( $path, $settings = [ ] ) {
		$this->loader = is_string( $path ) ? new \Mustache_Loader_FilesystemLoader( $path ) : $this->addPaths( $path );

		$this->environment = new \Mustache_Engine( array(
			'template_class_prefix' => '__MyTemplates_',
			'cache' => ROOT_PATH . '/tmp/cache/mustache',
			'cache_file_mode' => 0666, // Please, configure your umask instead of doing this :)
			'cache_lambda_templates' => true,
			'loader' => $this->loader, //new \Zesle\Mustache\Loader_FilesystemLoader( $this->getTemplatePath() ),
			//'partials_loader' => new \Zesle\Mustache\Loader_FilesystemLoader( dirname( __FILE__ ) . '/views/partials' ),
		...
		//$this->environment = new \Zesle\Mustache\Engine( $this->loader, $settings );
	}
